...
export const Terminal = ({ size, ...props }) => (
...
export const GraduationCap = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const BookOpen = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const Calendar = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const ShieldCheck = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const Wrench = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
  </IconWrapper>
);

export const Layers = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const GitFork = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const FolderGit2 = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
...
export const CheckCircle = ({ size, ...props }) => (
  <IconWrapper size={size} {...props}>
